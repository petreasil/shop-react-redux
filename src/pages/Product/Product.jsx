                ...
                <div className="product-page container-fluid container-min-max-width">
                    ...
                    <div className="product-info d-flex">
                        ...
                        <div className="product-details">
                            ...
                            <button
                                className="btn btn-dark mb-4 ml-3 font-weight-bold"
                                onClick={() => {
                            ...
                            <p><span className="font-weight-bold">Capacitate</span>: {product.capacity}</p>
                            <p><span className="font-weight-bold">Culoare</span>: {product.colour}</p>
                            <p><span className="font-weight-bold">Ram</span>: {product.ram}</p>
